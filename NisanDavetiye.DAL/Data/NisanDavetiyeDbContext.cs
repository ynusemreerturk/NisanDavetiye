...
public class NisanDavetiyeDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<TimelineOgesi>().HasData(
            new TimelineOgesi { Id = 1, Baslik = "Karşılama", Aciklama = "Misafirlerimizi karşılıyoruz.", Saat = "18:30", Sira = 1 },
            new TimelineOgesi { Id = 2, Baslik = "Nişan Töreni", Aciklama = "Nişan merasimimiz başlıyor.", Saat = "19:00", Sira = 2 },
            new TimelineOgesi { Id = 3, Baslik = "Kokteyl", Aciklama = "Kokteyl ve fotoğraf çekimi.", Saat = "20:00", Sira = 3 },
            new TimelineOgesi { Id = 4, Baslik = "Akşam Yemeği", Aciklama = "Akşam yemeği servisi.", Saat = "21:00", Sira = 4 }
        );
